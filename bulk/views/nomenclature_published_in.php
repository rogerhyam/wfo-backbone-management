...
function render_ask_form($name, $published_in, $data_year, $table, $row_id){
    ...
    echo "<table>";
    echo "<tr><th><a target=\"rhakhis\" href=\"https://list.worldfloraonline.org/rhakhis/ui/index.html#". $name->getPrescribedWfoID() . "\"/>". $name->getPrescribedWfoID() ."</a></th><td colspan=\"2\">".$name->getFullNameString()  ."</td></tr>";
